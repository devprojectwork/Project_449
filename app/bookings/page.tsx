...
import ViewItineraryButton from '@/components/ViewItineraryButton'; // 🧠 Add this line
            ...
            return (
              <TableRow key={id}>
                <TableCell>
                  ...
                  {/* 🧠 Show itinerary button below name */}
                  <ViewItineraryButton
  location={booking.property.country}
  days={booking.totalNights}
/>
                </TableCell>
                <TableCell>
